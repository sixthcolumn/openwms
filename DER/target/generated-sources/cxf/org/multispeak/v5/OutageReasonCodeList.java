 ...
 *         &lt;element name="outageCause" type="{http://www.multispeak.org/V5.0}outageReason" minOccurs="0"/>
 *         &lt;element name="equipmentFailure" type="{http://www.multispeak.org/V5.0}outageReason" minOccurs="0"/>
 *         &lt;element name="voltageLevel" type="{http://www.multispeak.org/V5.0}outageReason" minOccurs="0"/>
 *         &lt;element name="weatherCondition" type="{http://www.multispeak.org/V5.0}outageReason" minOccurs="0"/>
 *         &lt;element name="systemCharacterization" type="{http://www.multispeak.org/V5.0}outageReason" minOccurs="0"/>
 *         &lt;element name="responsibleSystem" type="{http://www.multispeak.org/V5.0}outageReason" minOccurs="0"/>
 *         &lt;element name="outageCondition" type="{http://www.multispeak.org/V5.0}outageReason" minOccurs="0"/>
 *         &lt;element name="interruptingDevice" type="{http://www.multispeak.org/V5.0}outageReason" minOccurs="0"/>
 *         &lt;element name="interruptingDeviceInitiation" type="{http://www.multispeak.org/V5.0}outageReason" minOccurs="0"/>
 *         &lt;element name="customerResoration" type="{http://www.multispeak.org/V5.0}outageReason" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
