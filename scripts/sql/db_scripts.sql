...
insert into package (id, name) values (6, 'DER');
...
insert into vendor_role_type (id, name) values (4, "OMS");
insert into vendor_role_type (id, name, active_flag) values (5, "DER", 1);
...
insert into vendor_role (id, name, vendor_role_type_id) values (1, 'DER', 5);
...
insert into interface(id,name,package_id,proxy_flag, required_flag, vendor_role_type_id) 
   values (40, 'DER(getDERsByDERID)', 6, 1, 1, 5);

insert into interface(id,name,package_id,proxy_flag, required_flag, vendor_role_type_id) 
   values (41, 'DER(createDERGroups)"', 6, 1, 1, 5);

insert into interface(id,name,package_id,proxy_flag, required_flag, vendor_role_type_id) 
   values (42, 'DER(getAttachmentsByObjectRefs)', 6, 1, 1, 5);

insert into interface(id,name,package_id,proxy_flag, required_flag, vendor_role_type_id) 
   values (43, 'DER(command)', 6, 1, 1, 5);
