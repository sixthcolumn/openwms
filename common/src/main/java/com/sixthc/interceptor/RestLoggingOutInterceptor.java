...
public class RestLoggingOutInterceptor extends AbstractLoggingInterceptor {
	...
	private static final Logger LOG = LogUtils
			.getLogger(RestLoggingOutInterceptor.class);
	private static final String LOG_SETUP = RestLoggingOutInterceptor.class
			.getName() + ".log-setup";
	...
	public RestLoggingOutInterceptor(String phase) {
		super(phase);
	...
	public RestLoggingOutInterceptor(int lim) {
		this();
		limit = lim;
	}

	public RestLoggingOutInterceptor(PrintWriter w) {
		this();
		this.writer = w;
	}
