...
/*Data for the table `identified_object_procedures` */
...
CREATE TABLE `work_task` (
  ...
  `old_identified_object_id` int(11) DEFAULT NULL COMMENT 'cim.work.worktask.oldAsset',
  PRIMARY KEY (`id`),
  KEY `fk_work_task_old_asset_id` (`old_identified_object_id`),
  CONSTRAINT `fk_work_task_old_asset_id` FOREIGN KEY (`old_identified_object_id`) REFERENCES `identified_object` (`id`)
