...
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8 COMMENT='cim.asset.hazards';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `address_internal_loc`
--

LOCK TABLES `address_internal_loc` WRITE;
/*!40000 ALTER TABLE `address_internal_loc` DISABLE KEYS */;
/*!40000 ALTER TABLE `address_internal_loc` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8 COMMENT='cim.asset  position points';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=89 DEFAULT CHARSET=utf8 COMMENT='cim.asset';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `crew_assets`
--

LOCK TABLES `crew_assets` WRITE;
/*!40000 ALTER TABLE `crew_assets` DISABLE KEYS */;
/*!40000 ALTER TABLE `crew_assets` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `crew_contactpersons`
--

LOCK TABLES `crew_contactpersons` WRITE;
/*!40000 ALTER TABLE `crew_contactpersons` DISABLE KEYS */;
/*!40000 ALTER TABLE `crew_contactpersons` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `material_item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='cim.work.worktask.materialitem';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `procedure` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=utf8 COMMENT='cim.asset';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=113 DEFAULT CHARSET=utf8 COMMENT='msp, cim  \r\nworkrequest';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=155 DEFAULT CHARSET=utf8 COMMENT='cim.worklocation.hazards';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=95 DEFAULT CHARSET=utf8 COMMENT='cim.workrequest.names';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8 COMMENT='cim.work.timeschedules\r\n';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=89 DEFAULT CHARSET=utf8 COMMENT='cim.work.worklocation.pospoints\r\n';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 COMMENT='cim.work.worktasks';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='cim.work.worktask.assets';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='cim.work.worktasks.crews';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='cim.work.worktask.names';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `work_task_old_assets`
--

LOCK TABLES `work_task_old_assets` WRITE;
/*!40000 ALTER TABLE `work_task_old_assets` DISABLE KEYS */;
/*!40000 ALTER TABLE `work_task_old_assets` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-06-30  9:51:45
