 ...
 *         &lt;element name="Location" type="{http://iec.ch/TC57/2010/WorkRequest#}WorkLocation"/>
...
public class Asset {
    ...
    protected List<Asset.Names> names;
     ...
     * 
     */
    public List<Asset.Names> getNames() {
        if (names == null) {
            names = new ArrayList<Asset.Names>();
        }
        return this.names;
    }
    ...
    public static class Names {
        ...
        protected Asset.Names.NameType nameType;
         ...
         * @return
         *     possible object is
         *     {@link Asset.Names.NameType }
         *     
         */
        public Asset.Names.NameType getNameType() {
            return nameType;
        }
         ...
         *     
         */
        public void setNameType(Asset.Names.NameType value) {
            this.nameType = value;
        }
