 ...
 * 				contractor, supplier, manufacturer, customer, etc.
 * 			
 * 
...
public class Organisation {
    ...
    protected List<Organisation.Names> names;
     ...
     * {@link Organisation.Names }
     * 
     * 
     */
    public List<Organisation.Names> getNames() {
        if (names == null) {
            names = new ArrayList<Organisation.Names>();
        }
        return this.names;
    }
    ...
    public static class Names {
        ...
        protected Organisation.Names.NameType nameType;
         ...
         * @return
         *     possible object is
         *     {@link Organisation.Names.NameType }
         *     
         */
        public Organisation.Names.NameType getNameType() {
            return nameType;
        }
         ...
         *     
         */
        public void setNameType(Organisation.Names.NameType value) {
            this.nameType = value;
        }
