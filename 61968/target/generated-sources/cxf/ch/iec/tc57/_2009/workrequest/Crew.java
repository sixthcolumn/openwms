...
public class Crew {
    ...
    protected List<Crew.Names> names;
     ...
     * 
     */
    public List<Crew.Names> getNames() {
        if (names == null) {
            names = new ArrayList<Crew.Names>();
        }
        return this.names;
    }
    ...
    public static class Names {
        ...
        protected Crew.Names.NameType nameType;
         ...
         * @return
         *     possible object is
         *     {@link Crew.Names.NameType }
         *     
         */
        public Crew.Names.NameType getNameType() {
            return nameType;
        }
         ...
         *     
         */
        public void setNameType(Crew.Names.NameType value) {
            this.nameType = value;
        }
