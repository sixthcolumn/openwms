 ...
 * 2015-05-14T11:18:38.555-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "Request", 
                  wsdlLocation = "file:/Users/BenGoodwin/git/openwms/61968/wsdl/Request.wsdl",
...
public class Request extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/BenGoodwin/git/openwms/61968/wsdl/Request.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Request.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/BenGoodwin/git/openwms/61968/wsdl/Request.wsdl");
        }
        WSDL_LOCATION = url;
    }
