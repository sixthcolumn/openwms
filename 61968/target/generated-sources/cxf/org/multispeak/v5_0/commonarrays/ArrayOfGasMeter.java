...
import org.multispeak.v5.GasMeter;
 ...
 *       &lt;sequence>
 *         &lt;element name="electricMeter" type="{http://www.multispeak.org/V5.0}gasMeter" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfGasMeter {
    ...
    protected List<GasMeter> electricMeter;
     ...
     * 
     */
    public List<GasMeter> getElectricMeter() {
        if (electricMeter == null) {
            electricMeter = new ArrayList<GasMeter>();
        }
