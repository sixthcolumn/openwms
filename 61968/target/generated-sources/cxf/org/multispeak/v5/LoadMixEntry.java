...
import org.multispeak.v5_0.enumerations.LoadMixConnection;


/**
 * This is an electrical equipmentcatalog entry for a load mix.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="constantPower" type="{http://www.multispeak.org/V5.0/primitives}percent" minOccurs="0"/>
 *         &lt;element name="constantImpedance" type="{http://www.multispeak.org/V5.0/primitives}percent" minOccurs="0"/>
 *         &lt;element name="constantCurrent" type="{http://www.multispeak.org/V5.0/primitives}percent" minOccurs="0"/>
 *         &lt;element name="connection" type="{http://www.multispeak.org/V5.0/enumerations}loadMixConnection" minOccurs="0"/>
 ...
 *         &lt;element name="CIMLoadCharacteristics" type="{http://www.multispeak.org/V5.0}CIMLoadCharacteristics" minOccurs="0"/>
 *       &lt;/sequence>
    ...
    extends MspElectricalDefinition
{
    ...
    protected LoadMixConnection connection;
     ...
     * @return
     *     possible object is
     *     {@link LoadMixConnection }
     *     
     */
    public LoadMixConnection getConnection() {
        return connection;
    }
     ...
     *     
     */
    public void setConnection(LoadMixConnection value) {
