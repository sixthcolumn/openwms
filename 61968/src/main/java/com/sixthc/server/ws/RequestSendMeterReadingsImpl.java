...
public class RequestSendMeterReadingsImpl implements RequestMeterReadingsPort {
	private static org.apache.log4j.Logger log = Logger
	.getLogger(RequestMeterReadingsImpl.class);

	private SendMeterReadingsClient client;

	
	public SendMeterReadingsClient getClient() {
		return client;
	}

	public void setClient(SendMeterReadingsClient client) {
		this.client = client;
	}
