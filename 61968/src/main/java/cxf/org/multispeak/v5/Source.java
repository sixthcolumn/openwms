...
import org.multispeak.v5_0.enumerations.PhaseAssociation;
import org.multispeak.v5_0.enumerations.QuantityType;


/**
 * Source characterizes the type of data supplied by a meter for efficient reference by the readingObject/readingList/ meterReading/registers element or by the loadProfile/ channelList/channel elements.
 * 
 ...
 *         &lt;element name="quantityType" type="{http://www.multispeak.org/V5.0/enumerations}quantityType" minOccurs="0"/>
 *         &lt;element name="uom" type="{http://www.multispeak.org/V5.0/enumerations}uomKind" minOccurs="0"/>
 *         &lt;element name="accountability" type="{http://www.multispeak.org/V5.0/enumerations}accountability" minOccurs="0"/>
 *         &lt;element name="phase" type="{http://www.multispeak.org/V5.0/enumerations}phaseAssociation" minOccurs="0"/>
 *         &lt;element name="harmonic" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="transformerRatio" type="{http://www.multispeak.org/V5.0}transformerRatio" minOccurs="0"/>
 *         &lt;element name="displayFormat" type="{http://www.multispeak.org/V5.0}displayFormat" minOccurs="0"/>
