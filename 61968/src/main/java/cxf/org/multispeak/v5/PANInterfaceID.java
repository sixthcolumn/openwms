...
/**
 * The PANInterfaceID is the identifier for the interface to a premises area network. This identifier corresponds to the device that is variously called the energy services interface (ESI) or the energy services portal (ESP). If the PAN interface (ESI) is implemented as part of a meter or otherwise coupled with a meter, then the PANInterfaceID should be the same as the content of the meterID.
 * 
 * <p>Java class for PANInterfaceID complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PANInterfaceID">
 *   &lt;simpleContent>
...
@XmlType(name = "PANInterfaceID", propOrder = {
    "value"
})
public class PANInterfaceID {
