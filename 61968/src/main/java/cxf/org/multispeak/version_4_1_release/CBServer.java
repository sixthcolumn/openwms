 ...
 * 2015-07-20T15:46:22.597-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "CB_Server", 
                  wsdlLocation = "file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/cb_server_special.wsdl",
...
public class CBServer extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/cb_server_special.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CBServer.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/cb_server_special.wsdl");
        }
        WSDL_LOCATION = url;
    }
