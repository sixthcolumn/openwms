 ...
 * 2015-07-20T15:42:50.251-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "GetEndDeviceControls", 
                  wsdlLocation = "file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/GetEndDeviceControls.wsdl",
...
public class GetEndDeviceControls extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/GetEndDeviceControls.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GetEndDeviceControls.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/GetEndDeviceControls.wsdl");
        }
        WSDL_LOCATION = url;
    }
