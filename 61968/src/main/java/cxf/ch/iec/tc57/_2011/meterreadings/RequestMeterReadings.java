 ...
 * 2015-07-20T15:46:14.086-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "RequestMeterReadings", 
                  wsdlLocation = "file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/RequestMeterReadings.wsdl",
...
public class RequestMeterReadings extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/RequestMeterReadings.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RequestMeterReadings.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/RequestMeterReadings.wsdl");
        }
        WSDL_LOCATION = url;
    }
