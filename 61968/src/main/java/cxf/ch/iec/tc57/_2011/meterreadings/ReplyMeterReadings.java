 ...
 * 2015-07-20T15:46:13.411-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "ReplyMeterReadings", 
                  wsdlLocation = "file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/ReplyMeterReadings.wsdl",
...
public class ReplyMeterReadings extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/ReplyMeterReadings.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ReplyMeterReadings.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/ReplyMeterReadings.wsdl");
        }
        WSDL_LOCATION = url;
    }
