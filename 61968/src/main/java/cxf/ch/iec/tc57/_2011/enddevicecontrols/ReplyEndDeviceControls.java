 ...
 * 2015-07-20T15:46:15.638-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "ReplyEndDeviceControls", 
                  wsdlLocation = "file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/ReplyEndDeviceControls.wsdl",
...
public class ReplyEndDeviceControls extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/ReplyEndDeviceControls.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ReplyEndDeviceControls.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/ReplyEndDeviceControls.wsdl");
        }
        WSDL_LOCATION = url;
    }
