 ...
 * 2015-07-20T15:46:16.453-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "SendMeterReadSchedule", 
                  wsdlLocation = "file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/SendMeterReadSchedule.wsdl",
...
public class SendMeterReadSchedule extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/SendMeterReadSchedule.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SendMeterReadSchedule.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/SendMeterReadSchedule.wsdl");
        }
        WSDL_LOCATION = url;
    }
