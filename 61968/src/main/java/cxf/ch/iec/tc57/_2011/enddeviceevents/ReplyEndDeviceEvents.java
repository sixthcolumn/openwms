 ...
 * 2015-07-20T15:46:16.131-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "ReplyEndDeviceEvents", 
                  wsdlLocation = "file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/ReplyEndDeviceEvents.wsdl",
...
public class ReplyEndDeviceEvents extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/ReplyEndDeviceEvents.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ReplyEndDeviceEvents.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/ReplyEndDeviceEvents.wsdl");
        }
        WSDL_LOCATION = url;
    }
