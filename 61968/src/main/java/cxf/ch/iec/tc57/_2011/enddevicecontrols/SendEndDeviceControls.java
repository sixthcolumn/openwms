 ...
 * 2015-07-20T15:46:15.448-04:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "SendEndDeviceControls", 
                  wsdlLocation = "file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/SendEndDeviceControls.wsdl",
...
public class SendEndDeviceControls extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/SendEndDeviceControls.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SendEndDeviceControls.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/BenGoodwin/git/opentemp2/openwms/61968/wsdl/SendEndDeviceControls.wsdl");
        }
        WSDL_LOCATION = url;
    }
