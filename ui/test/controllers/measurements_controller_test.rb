...
class MeasurementsControllerTest < ActionController::TestCase
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post :create, measurement: { phases: @measurement.phases, type: @measurement.type, unit_multiplier: @measurement.unit_multiplier, unit_symbol: @measurement.unit_symbol }
    end
  ...
  test "should update measurement" do
    patch :update, id: @measurement, measurement: { phases: @measurement.phases, type: @measurement.type, unit_multiplier: @measurement.unit_multiplier, unit_symbol: @measurement.unit_symbol }
    assert_redirected_to measurement_path(assigns(:measurement))
  end
