...
class InterfacesControllerTest < ActionController::TestCase
  ...
  test "should create interface" do
    assert_difference('Interface.count') do
      post :create, interface: { name: @interface.name, package_id: @interface.package_id, proxy_flag: @interface.proxy_flag, required_flag: @interface.required_flag, vendor_role_type_id: @interface.vendor_role_type_id }
    end
  ...
  test "should update interface" do
    patch :update, id: @interface, interface: { name: @interface.name, package_id: @interface.package_id, proxy_flag: @interface.proxy_flag, required_flag: @interface.required_flag, vendor_role_type_id: @interface.vendor_role_type_id }
    assert_redirected_to interface_path(assigns(:interface))
  end
