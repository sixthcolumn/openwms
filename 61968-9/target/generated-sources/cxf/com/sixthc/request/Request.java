 ...
 * 2014-11-06T16:00:54.229-05:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "Request", 
                  wsdlLocation = "file:/C:/sixth/epri/der_harness/src/testharness/61968-9/wsdl/Request.wsdl",
...
public class Request extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/sixth/epri/der_harness/src/testharness/61968-9/wsdl/Request.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Request.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/sixth/epri/der_harness/src/testharness/61968-9/wsdl/Request.wsdl");
        }
        WSDL_LOCATION = url;
    }
