 ...
 * 2014-11-06T16:00:43.952-05:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "GetMeterReadings", 
                  wsdlLocation = "file:/C:/sixth/epri/der_harness/src/testharness/61968-9/wsdl/GetMeterReadings.wsdl",
...
public class GetMeterReadings extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/sixth/epri/der_harness/src/testharness/61968-9/wsdl/GetMeterReadings.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GetMeterReadings.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/sixth/epri/der_harness/src/testharness/61968-9/wsdl/GetMeterReadings.wsdl");
        }
        WSDL_LOCATION = url;
    }
