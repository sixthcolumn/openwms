 ...
 * 2014-11-06T16:00:46.058-05:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "ReplyMeterServiceRequests", 
                  wsdlLocation = "file:/C:/sixth/epri/der_harness/src/testharness/61968-9/wsdl/ReplyMeterServiceRequests.wsdl",
...
public class ReplyMeterServiceRequests extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/sixth/epri/der_harness/src/testharness/61968-9/wsdl/ReplyMeterServiceRequests.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ReplyMeterServiceRequests.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/sixth/epri/der_harness/src/testharness/61968-9/wsdl/ReplyMeterServiceRequests.wsdl");
        }
        WSDL_LOCATION = url;
    }
