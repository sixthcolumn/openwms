 ...
 * 2014-11-06T16:00:53.588-05:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "CB_Server", 
                  wsdlLocation = "file:/C:/sixth/epri/der_harness/src/testharness/61968-9/wsdl/cb_server_special.wsdl",
...
public class CBServer extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/sixth/epri/der_harness/src/testharness/61968-9/wsdl/cb_server_special.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CBServer.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/sixth/epri/der_harness/src/testharness/61968-9/wsdl/cb_server_special.wsdl");
        }
        WSDL_LOCATION = url;
    }
